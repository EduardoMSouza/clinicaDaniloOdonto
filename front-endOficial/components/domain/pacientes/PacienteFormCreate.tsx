// components/domain/pacientes/PacienteFormCreate.tsx
"use client"
...
import { User, Phone, FileText, Calendar, MapPin, Briefcase, ArrowLeft, Heart, AlertTriangle, Stethoscope, Droplets } from "lucide-react"
import { Sexo, EstadoCivil } from "@/types/pacientesType"
import { Button } from "@/components/ui/button"

interface PacienteFormCreateProps {
    onSuccess: () => void
    onCancel: () => void
    isPage?: boolean
}

function PacienteFormCreate({ onSuccess, onCancel, isPage = false }: PacienteFormCreateProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Use getFormData() para obter os dados no formato correto
            await pacienteService.create(getFormData())
    ...
    // Função auxiliar para campos select
    ...
    return (
        <form onSubmit={handleSubmit} className={isPage ? "max-w-6xl mx-auto" : ""}>
